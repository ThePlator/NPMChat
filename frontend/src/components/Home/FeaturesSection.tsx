        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((f, i) => (
            <div
              ...
              <span className="text-4xl mb-4 group-hover:animate-bounce group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 transform-gpu">{f.icon}</span>
              <h3 className="text-xl font-bold mb-2 text-black group-hover:scale-105 group-hover:animate-pulse transition-all duration-300">{f.title}</h3>
              <p className="text-base font-medium text-black group-hover:scale-105 group-hover:translate-x-1 transition-all duration-300">{f.desc}</p>
