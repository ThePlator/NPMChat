        ...
        <div className="space-y-6">
          {useCases.map((uc, index) => (
            <div
              ...
              <span className="text-lg font-bold text-black group-hover:scale-105 group-hover:translate-x-2 group-hover:animate-pulse transition-all duration-300">{uc.text}</span>
