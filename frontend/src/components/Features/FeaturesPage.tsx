...
const mainFeatures = [
  {
    ...
    description: 'Instant, room-based chat powered by WebSockets. Connect with your team in real-time with zero delay and perfect synchronization.',
    bgColor: 'bg-[#e9d5ff]',
    details: ['WebSocket technology', 'Room-based organization', 'Typing indicators', 'Message history']
  },
  {
    icon: <Code2 className="w-8 h-8 text-green-600" />,
    title: 'Collaborative Code Editor',
    description: 'A live, shared Monaco editor for pair programming. Write, edit, and debug code together with real-time collaboration features.',
    bgColor: 'bg-[#d9f99d]',
    details: ['Monaco Editor integration', 'Live cursor tracking', 'Syntax highlighting', 'Multi-language support']
  },
  {
    icon: <Clock className="w-8 h-8 text-orange-600" />,
    title: 'Live Interview Mode',
    description: 'A specialized room with a timer and prompts to conduct mock interviews. Perfect for technical assessments and coding challenges.',
    bgColor: 'bg-[#fef6e4]',
    details: ['Built-in timer', 'Question prompts', 'Screen sharing', 'Assessment tools']
  },
  {
    icon: <FileText className="w-8 h-8 text-blue-600" />,
    title: 'Shared Scratchpads',
    description: 'A persistent notepad and code snippet manager for each chat room. Save, organize, and share your thoughts and code snippets.',
    bgColor: 'bg-[#e0f2fe]',
    details: ['Persistent storage', 'Code snippet library', 'Markdown support', 'Quick notes']
  },
  {
    icon: <Upload className="w-8 h-8 text-pink-600" />,
    title: 'File Sharing & Previews',
    description: 'Drag-and-drop file sharing with syntax highlighting for code files. Upload and preview .js, .py, and more directly in chat.',
    bgColor: 'bg-[#fce7f3]',
    details: ['Drag & drop support', 'Code previews', 'Multiple file formats', 'Download protection']
  },
  {
    icon: <Play className="w-8 h-8 text-red-600" />,
    title: 'Code Execution Engine',
    description: 'Run code snippets directly within the chat and see the output instantly. Powered by external APIs like Piston and Judge0.',
    bgColor: 'bg-[#fee2e2]',
    details: ['Multiple languages', 'Instant execution', 'Output display', 'Error handling']
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mainFeatures.map((feature, index) => (
              <div key={index} className={`${feature.bgColor} border-4 border-black p-8 shadow-[8px_8px_0_0_rgba(0,0,0,1)] hover:shadow-[8px_8px_0_0_rgba(0,0,0,1)] transition-all hover:-translate-y-1`}>
                ...
                <div className="space-y-2">
                  {feature.details.map((detail, idx) => (
                    <div key={idx} className="flex items-center text-sm font-bold text-gray-700">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {additionalFeatures.map((feature, index) => (
              <div key={index} className="bg-white border-4 border-black p-6 shadow-[8px_8px_0_0_rgba(0,0,0,1)] hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)] transition-all hover:-translate-y-1">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white border-4 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)] overflow-hidden">
            <div className="grid grid-cols-4 gap-0 text-black">
              ...
              <div className="border-r-4 border-t-4 border-black p-4 font-bold">Code Editor</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-green-600 font-bold">✓</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              <div className="border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              
              <div className="border-r-4 border-t-4 border-black p-4 font-bold">Code Execution</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-green-600 font-bold">✓</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              <div className="border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              
              <div className="border-r-4 border-t-4 border-black p-4 font-bold">Interview Mode</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-green-600 font-bold">✓</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              <div className="border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              
              <div className="border-r-4 border-t-4 border-black p-4 font-bold">Open Source</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-green-600 font-bold">✓</div>
              <div className="border-r-4 border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
              <div className="border-t-4 border-black p-4 text-center text-red-600 font-bold">✗</div>
            </div>
